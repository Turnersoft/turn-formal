use crate::formalize_v2::subjects::math::theories::analysis::definition::spaces::BanachSpace;
...
pub struct MeasurableSpace {
    ...
    pub sigma_algebra: SigmaAlgebraType,
